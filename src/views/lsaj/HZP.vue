  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-table-column align="center" prop="value" label="值" width="200">
        </el-table-column>
      </el-table>
    </Popup>
    <Legend
    ...
    <data-bar title="Top10化妆品案件" id="dataBar">
      <el-table
        :data="caseData"
        border
        style="width: 100%"
...
export default {
      ...
      legendItems: [
        {
          index: 1,
          text: "0",
          style: "backgroundColor:#B3E3EE",
        },
        {
          index: 2,
          text: "1 - 3",
          style: "backgroundColor:#6BADBB",
        },
        {
          index: 3,
          text: "4 - 12",
          style: "backgroundColor:#247888",
        },
        {
          index: 4,
          text: "13 - 28",
          style: "backgroundColor:#015E6F",
        },
      ],
      caseData: [],
    };
  ...
  methods: {
    initLayers() {
      ...
      add_tms(window.MAP, "syh-gzqx_line", "line", {
        "line-color": "#757575",
        "line-width": 1.1,
      });
      add_tms(window.MAP, "syh-hzp_mkt", "circle", {
        "circle-color": "#ffa726",
        "circle-radius": 6,
    ...
    rowClass({ row, rowIndex }) {
      return "font:bold 14px '微软雅黑';color:#616161;";
    },
  ...
  destroyed() {
    removeLayers(window.MAP, ["syh-gzqx_line", "syh-sqaj", "syh-hzp_mkt"]);
  },
};
</script>
