<template>
  <div>
    ...
    <data-bar title="Top10药品案件" id="dataBar">
      <el-table
        :data="caseData"
        border
        style="width: 100%"
...
export default {
      ...
      legendItems: [
        {
          index: 1,
          text: "0",
          style: "backgroundColor:#A4B7DE",
        },
        {
          index: 2,
          text: "1",
          style: "backgroundColor:#8D92D0",
        },
        {
          index: 3,
          text: "2 - 3",
          style: "backgroundColor:#766DC2",
        },
        {
          index: 4,
          text: "4 - 7",
          style: "backgroundColor:#6049B4",
        },
        {
          index: 5,
          text: "8 - 16",
          style: "backgroundColor:#4924A6",
        },
        {
          index: 6,
          text: "17 - 34",
  ...
  methods: {
    initLayers() {
      ...
      add_tms(window.MAP, "syh-yp_mkt", "circle", {
        "circle-color": "#eeff41",
        "circle-radius": 6,
  ...
  destroyed() {
    removeLayers(window.MAP, ["gzqx_line", "syh-sqaj", "syh-yp_mkt"]);
  },
};
</script>
